              ...
              <div class="col-md-8">
                  <div class="card">
                      <div class="card-header" data-background-color="purple">
                          <h4 class="title">Modificar Registro de salidas</h4>
                          <p class="category"></p>
                      </div>
                      <div class="card-content">
                          <form>
                              ...
                              <button type="submit" class="btn btn-primary pull-right">Guardar salida</button>
                  ...
                  <div class="card card-profile">
                      ...
                      <div class="content">
                          ...
                          <p class="card-content">
                              Sabias que... Marcar a tiempo favorece tu récord de empleado.
                          </p>
                      </div>
                  </div>
              </div>
