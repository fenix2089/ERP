              ...
              <div class="col-md-8">
                  <div class="card">
                      <div class="card-header" data-background-color="purple">
                          <h4 class="title">Modificar información de cliente</h4>
                          <p class="category"></p>
                      </div>
                      <div class="card-content">
                          <form action="php/update.php" method="POST" role="form">
                              <div class="row">
                                  <div class="col-md-12">
                  ...
                  <div class="card card-profile">
                      ...
                      <div class="content">
                          ...
                          <p class="card-content">
                              Sabias que... En esta pestaña puedes modificar la información de tus clientes y actualizar sus datos.
                          </p>
                      </div>
                  </div>
              </div>
