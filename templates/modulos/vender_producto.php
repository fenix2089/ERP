<?php
  ...
  $datos = $services->MostrarAbastecer($id);
          ...
          <div class="col-md-12">
              <div class="card">
                  <div class="card-header" data-background-color="purple">
                      <h4 class="title">Producto a Vender Código: <?php echo "<b>".$id."</b> "; ?></h4>
                  </div>
                  <div class="card-content table-responsive">
                    <form action="../../models/model_venta.php" method="POST">
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <input type="int" name="precio" value="<?php echo $datos[$i]["PRECIO_VENTA"]; ?>" class="form-control"  required>
                        <?php
                          }
                        ?>
                        </div>
                        <div class="col-md-6">
                          ...
                          <legend><b>Detalle de venta</b></legend>
                          ...
                          <label for="">Cantida a Vender</label>
                        ...
                        <button class="btn btn-primary" name="btn_abas">Vender</button>
                      </div>
                    </form>
                  </div>
              </div>
