<?php
  ...
  $services1 = new Clientes();
  $datos1 = $services1->Consultar();
  
  require_once("../../models/model_orden_venta.php");
  $nservices = new Ordenesv();
  $ndatos = $nservices->Consultar();
            ...
            <div class="col-md-4">
                  <div class="card">
                      <div class="card-header" data-background-color="purple">
                          <h4 class="title">Generar Recibo de Venta</h4>
                          <p class="category"></p>
                      </div>
                      <div class="card-content">
                        <form action="#" method="POST">
                          <select name="id_o" class="form-control">
                            <option disabled selected>Selecione código de orden de venta</option>
                        <?php  
                            for ($i = 0; $i < count($ndatos); $i++) {
                          ?>
                            <option value="<?php echo $ndatos[$i]['OrdenV']; ?>"><?php echo "Orden = ".$ndatos[$i]['OrdenV'].' Realizada por = '.$ndatos[$i]['Empleado'].'| Fecha: '.$ndatos[$i]['Fecha']; ?>
                            </option>
                          <?php
                            }
                          ?>
                        ...
                        <?php 
                          if (isset($_POST['btn_recibo'])) 
                          {
                            ...
                            $recibo= $nuevo->Reciboventa($_POST['id_o']);
                          }
                        ?>
                      </div>
                  </div>
              ...
              <div class="col-md-6">
                  <div class="card">
                      <div class="card-header" data-background-color="purple">
                          <h4 class="title">Buscar Recibo de Venta</h4>
                          <p class="category"></p>
                      </div>
                      <div class="card-content">
                          <form action="recibo_de_venta.php" method="POST">
                              <div class="row">
                                  <div class="col-md-8">
                                      ...
                                      <?php  
                                        ...
                                        ?>
                                          <option value="<?php echo $datos1[$i]['id_cliente']; ?>"><?php echo "ID = ".$datos1[$i]['id_cliente'].'| Cliente = '.$datos1[$i]['nombre_c'].' '.$datos1[$i]['apellido_c']; ?>
                                          </option>
                                        <?php
                                          }
                                        ?>
