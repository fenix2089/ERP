...
<?php  
	...
	$datos = $services->Consultar1($id_e, $fi, $ff, $id_venta, $id_cliente);
	$datos2 = $services->Consultar2($id_e, $fi, $ff, $id_venta, $id_cliente);
...
<?php  
		if ($datos == false) {
			...
			echo $id_e;
			echo "</h6></b>";
			echo "Cliente con ID =".' '.$id_cliente;		
?>
			<a href="./consultas_recibos_venta.php"><button class="oculto  btn red darken-4" type='button' value='cancelar' />Regresar</button></a>
			</div>
<?php
		}
		elseif ($datos == true) 
					...
					<div class="col-12 col-sm-12 col-md-12">
						<div class="card ">
							<div class="card-header oculto" data-background-color="purple">
								<h6 class="title">Recibo de Venta</h6>
							</div>
									...
									<div class="col s12">
										<table class="table highlight">
									  	...
									  	<tbody>
											...
											<tr>
												<td colspan="9" style="text-left: right;"><b><label for="">CLIENTE:  </label> <?php echo $datos2[5]; ?></b></td>
											</tr>
											<tr>
