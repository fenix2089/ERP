              ...
              <div class="col-md-8">
                  <div class="card">
                      <div class="card-header" data-background-color="purple">
                          <h4 class="title">Actualizar categorias clientes</h4>
                          <p class="category"></p>
                      </div>
                      <div class="card-content">
                          <form>
                              ...
                              <button type="submit" class="btn btn-primary pull-right">Modificar categoría de cliente</button>
                  ...
                  <div class="card card-profile">
                      ...
                      <div class="content">
                          ...
                          <p class="card-content">
                              Sabias que... Nuestros clientes son clasificados por categoría, y que pueden ascender cada vez que realizan una compra. Modificala en ésta área!
                          </p>
                      </div>
                  </div>
              </div>
