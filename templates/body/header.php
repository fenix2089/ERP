...
<body>
    ...
    <div class="sidebar" data-color="purple" data-image="../img/iconos/erp2.png">
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                <li>
                    <a href="../templates/modulos/reabastecer.php">
                        <i class="material-icons">equalizer</i>
                        <p>Reabastecer</p>
                    </a>
                </li>
                 <li>
                    <a href="../templates/modulos/producto.php">
                        <i class="material-icons">equalizer</i>
                        <p>Productos</p>
                    </a>
                </li>
                ...
                <li>
                    <a href="../templates/modulos/consultas_recibos_compra.php">
                        <i class="material-icons">library_books</i>
                        <p>Recibos de Compras</p>
                    </a>
                </li>
                <li>
                    <a href="../templates/modulos/consultas_recibos_venta.php">
                        <i class="material-icons">library_books</i>
